...
> É necessário notar que a forma como essa url será "servida" depende de como será feita (geralmente usa-se nginx, apache...)

Uma vez feito isso, vá até o terminal e rode:
```bash
node main.js
```
...
[

  {
    ...
    "rssi": "number",
    "raw": "string",
    "time": "string", // timestamps with time zone in Seconds or GMT 0
  }
]
```
 ...
 { // RMMS
  ...
  { // TILT
    ...
    time: [
      ...
      '2020-01-28T14:25:16.000Z',
      '2020-01-28T14:25:18.000Z',
      '2020-01-28T14:25:20.000Z'
    ]
  },
  { // FFT
    res: '16 bits',
